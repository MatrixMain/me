...
function popup1() {
    CreativaPopup.create('Feel free to DM me ikusimpriz', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">Ikusimpriz</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://discord.gg/8rkUUuVUq4" style="color: #ADD8E6;">https://discord.gg/8rkUUuVUq4</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd1() {
    navigator.clipboard.writeText("Ikusimpriz");
    setTimeout(function() {
        alert("Discord username was copied to the clipboard");
    }, 50);
}
